...
package com.redhat.fsw.poc.soap_helloworld.bean.hw;
 ...
 * generated in the com.redhat.fsw.poc.soap_helloworld.bean.hw package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldResponse_QNAME = new QName("urn:com.redhat.fsw.poc:soap-helloworld:1.0", "sayHelloWorldResponse");
    private final static QName _SayHelloWorld_QNAME = new QName("urn:com.redhat.fsw.poc:soap-helloworld:1.0", "sayHelloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.redhat.fsw.poc.soap_helloworld.bean.hw
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:com.redhat.fsw.poc:soap-helloworld:1.0", name = "sayHelloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:com.redhat.fsw.poc:soap-helloworld:1.0", name = "sayHelloWorld")
